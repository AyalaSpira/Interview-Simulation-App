...
using InterviewSim.DAL.Repositories; // ודא שזה מיובא עבור IUserRepository
...
namespace InterviewSim.DAL.Repositories
{
    public class UserRepository : IUserRepository
    {
        ...
        // ✅ הוסף את המתודה החדשה לפגינציה
        public async Task<List<UserDTO>> GetPagedUsersAsync(int pageNumber, int pageSize)
        {
            var users = await _context.Users
            .OrderBy(u => u.UserId) // חשוב למיין כדי לקבל תוצאות עקביות בפגינציה
        ...
        // ✅ הוסף את המתודה החדשה לספירת סך המשתמשים
